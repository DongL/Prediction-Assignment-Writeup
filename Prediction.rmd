...
## Data Acquisition
In order to predict the pattern of acitvities when they did the exercise, a random forest model was built using the training dataset. The training and test data are downloade directly from the weblink as follows: [Training](https://d396qusza40orc.cloudfront.net/predmachlearn/pml-training.csv), [Testing]("https://d396qusza40orc.cloudfront.net/predmachlearn/pml-testing.csv").
...
The variable importance is shown 
```{r}
varImp(mod)
